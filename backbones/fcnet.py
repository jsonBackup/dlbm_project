...
class FCNet(nn.Module):
    ...
    def __init__(self, x_dim, layer_dim=[64, 64], dropout=0.2, fast_weight=False, *args, **kwargs):
...
class EnFCNet(nn.Module):
    ...
    def __init__(self, x_dim, go_mask, hid_dim=64, z_dim=64, dropout=0.2, *args, **kwargs):
